...
parser: clean_parser main_parser.c parser.c parser.h scanner.c scanner.h token.c token.h dynamicStr.c dynamicStr.h dynamicArrParam.c dynamicArrParam.h stackStr.c stackStr.h stackTkn.c stackTkn.h queue.c queue.h symtable.c symtable.h error.c error.h sa_prec.c sa_prec.h stack_sa_prec.c stack_sa_prec.h parser_gen.c parser_gen.h
	gcc $(CFLAGS) main_parser.c parser.c error.c scanner.c token.c dynamicStr.c dynamicArrParam.c stackStr.c stackTkn.c queue.c symtable.c sa_prec.c stack_sa_prec.c parser_gen.c -o parser
